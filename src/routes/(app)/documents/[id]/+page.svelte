<script lang="ts">
	...
	// WI-014 superseded WI-008: the LLM-driven editing flow now lives
	// inside the chat surface via the "📄 Document" toolbar button +
	// docgen_* tool calls. This route stays as the direct-edit escape
	// hatch — open the editor without a chat context, e.g. for
	// Geoportaal hand-off (WI-006 design intent).
